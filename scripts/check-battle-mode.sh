...
check_doc "readability as a fixed juice budget"
check_doc "At most one strong celebration accent should compete for attention at a time"
check_doc "receptor timing first, active vocabulary cue second, performance meter and combo third, opponent or background spectacle last"
check_doc "cut or soften background, opponent, and combo effects before touching the active vocabulary cue or receptor clarity"
check_doc "Lane travel space around the next incoming note should stay clear of lingering particles, flashes, or overlays"
